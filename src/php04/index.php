...
<body>
    <header class="header">
        <div class="header_inner">
            <a class="header_logo" href="/php04">Status Code Quiz</a>
        </div>
    </header>
    <main>
            ...
            <form class="quiz-form" action="result.php" method="post">
                ...
                <div class="quiz-form_item">
                    ...
                    <div class="quiz-form_group">
                        ...
                        <label class="quiz-form_label" for="<?php echo $option['code'] ?>"><?php echo $option['code'] ?></label>
                    </div>
                    <?php endforeach;?>
                </div>
                <div class="quiz-form_button">
                    <button class="quiz-form_button-submit" type="submit">回答</button>
                </div>
            </form>
        </div>
    </main>
